    ...
    'warmup_squat_sky': ExerciseProgression(
      ...
      levels: [
        ProgressionLevel(
          ...
          gifPath: 'assets/gifs/warmup/squat_sky_reaches_assisted.gif',
        ),
        ProgressionLevel(
          level: 1,
        ...
        ProgressionLevel(
          ...
          gifPath: 'assets/gifs/warmup/squat_sky_reaches_extended.gif',
        ),
      ],
    ),
    'warmup_arch_hangs': ExerciseProgression(
      ...
      levels: [
        ProgressionLevel(
          ...
          gifPath: 'assets/gifs/warmup/arch_hangs_scapular.gif',
        ),
        ProgressionLevel(
          level: 1,
          name: 'Arch Hangs',
    ...
    'strength_hinge': ExerciseProgression(
      ...
      levels: [
        ...
        ProgressionLevel(
          ...
          gifPath: 'assets/gifs/strength/hinge_5.gif',
        ),
        ProgressionLevel(
          level: 6,
          ...
          gifPath: 'assets/gifs/strength/hinge_6.gif',
        ),
        ProgressionLevel(
          level: 7,
    ...
    'strength_row': ExerciseProgression(
      ...
      levels: [
        ...
        ProgressionLevel(
          ...
          gifPath: 'assets/gifs/strength/row_5.gif',
        ),
        ProgressionLevel(
          level: 6,
          ...
          gifPath: 'assets/gifs/strength/row_6.gif',
        ),
        ProgressionLevel(
          level: 7,
    ...
    'strength_pushup': ExerciseProgression(
      ...
      levels: [
        ...
        ProgressionLevel(
          ...
          gifPath: 'assets/gifs/strength/pushup_5.gif',
        ),
        ProgressionLevel(
          level: 6,
          ...
          gifPath: 'assets/gifs/strength/pushup_6.gif',
        ),
        ProgressionLevel(
          level: 7,
    ...
    'core_anti_extension': ExerciseProgression(
      ...
      levels: [
        ...
        ProgressionLevel(
          ...
          description: 'Use a wall to shorten the ROM and make it easier. The further you are from the wall, the more difficult it becomes. Keep a hollow body position (ribs down, butt tucked), brace your core, and squeeze your glutes.',
          gifPath: 'assets/gifs/core/anti_extension_3.gif',
        ),
        ProgressionLevel(
          level: 4,
          ...
          gifPath: 'assets/gifs/core/anti_extension_4.gif',
        ),
        ProgressionLevel(
          level: 5,
    ...
    'core_anti_rotation': ExerciseProgression(
      ...
      levels: [
        ...
        ProgressionLevel(
          ...
          gifPath: 'assets/gifs/core/anti_rotation_2.gif',
        ),
        ProgressionLevel(
          level: 3,
          name: 'Assisted Copenhagen Plank (Alt Path 1)',
          description: 'Lower leg should give the minimum assistance you need. Don\'t let the hips sag. Can be performed on your hand instead of elbow.',
          gifPath: 'assets/gifs/core/anti_rotation_3.gif',
        ),
        ProgressionLevel(
          level: 4,
          name: 'Copenhagen Plank (Alt Path 1)',
          description: 'Don\'t let the hips sag. Can be performed on your hand instead of elbow.',
          gifPath: 'assets/gifs/core/anti_rotation_4.gif',
        ),
        ProgressionLevel(
          level: 5,
          ...
          gifPath: 'assets/gifs/core/anti_rotation_5.gif',
        ),
        ProgressionLevel(
          level: 6,
          ...
          gifPath: 'assets/gifs/core/anti_rotation_6.gif',
        ),
      ],
    ),
